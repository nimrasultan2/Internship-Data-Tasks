...
2. I created visualizations to understand the data whch i learnt in Task02: 
        1. Histograms: To see the common ranges of requested loan amounts.
        2. Count Plots: To compare how education levels impact loan approval.
        3. Box Plots: To identify if higher applicant income correlates with lower default rates.
...
The Confusion Matrix is the ultimate proof of fulfillment. It shows:
    1. True Positives: People predicted to be safe who actually were safe.
    2. True Negatives: People predicted to be risky who actually were risky.
