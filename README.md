...
I used the pandas library to load the CSV dataset and performed an initial health check using .shape, .info(), .columns, and .head() to understand the data types and dimensions.
Also, Cleaned data using the following:
       I identified and handled null entries to prevent errors in later calculations.
